...
public class MouseMatrixLeftAndCenter implements MouseListener{

	@Override
	public void mouseClicked(MouseEvent e) {
		// TODO Auto-generated method stub
		JLabel now = (JLabel)e.getSource();
		PanelCenterMain CenterMain;
		try {
			...
			if(IsHost.check(Integer.parseInt(now.getName()))){
			...
			new FrameNotification("Maybe something went wrong when you were trying to open a host or a service<br>" +e1.getMessage());
		}
